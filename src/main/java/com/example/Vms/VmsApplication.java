...
public class VmsApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		String time1Str = "01:00 PM";
		String time2Str = "06:00 PM";
...
//		Organisation organisation =repo.findById(1).get();
//		System.out.println(organisation.getMessages());
//		User user = userRepo.findByName("rahul").orElse(null);
//		System.out.println(user.getMessages());
//		System.out.println(organisation.getWaitingListUserIds());
		}
	}
